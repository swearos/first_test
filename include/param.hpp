...
#ifndef OBJECT_DETECT_PARAM_HPP_HPP
#define OBJECT_DETECT_PARAM_HPP_HPP
...
public:
    ...
    //add scale_multiple_of for pvanet model
    static float scale_multiple_of;
...
#endif //OBJECT_DETECT_PARAM_HPP_HPP
